        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('Update_Data_User', $i->id) }}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ $i->username }}" required autocomplete="username" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="no_hp" type="text" class="form-control @error('no_hp') is-invalid @enderror" name="no_hp" value="{{ $i->no_hp }}" required autocomplete="no_hp">
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="text" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ $i->password }}" required autocomplete="password">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{route('Data_User')}}" class="btn btn-danger">
                                    {{ __('Back') }}
                                </a>
                            </div>
                        </div>
